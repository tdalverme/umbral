...
$testPaths = @(
    ...
    "tests\contract\test_agent_evals_v4_contracts.py",
    ...
    "tests\integration\agent_evals\test_same_path.py",
...
Write-Host "[PASS] Checks agent evals (dataset golden, releases, price, regression gate, single-path trials, budgets, dashboard, ADR, migration 0012)"
