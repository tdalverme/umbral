...
export const listSearchProfilePreferencesQueryKey = (options?: Options<ListSearchProfilePreferencesData>) => createQueryKey('listSearchProfilePreferences', options);

/**
 * List Search Profile Preferences
 */
export const listSearchProfilePreferencesOptions = (options?: Options<ListSearchProfilePreferencesData>) => queryOptions<ListSearchProfilePreferencesResponse, ListSearchProfilePreferencesError, ListSearchProfilePreferencesResponse, ReturnType<typeof listSearchProfilePreferencesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listSearchProfilePreferences({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listSearchProfilePreferencesQueryKey(options)
});
...
export const getUrbanSignalsQueryKey = (options?: Options<GetUrbanSignalsData>) => createQueryKey('getUrbanSignals', options);

/**
 * Get Urban Signals
 */
export const getUrbanSignalsOptions = (options?: Options<GetUrbanSignalsData>) => queryOptions<GetUrbanSignalsResponse, DefaultError, GetUrbanSignalsResponse, ReturnType<typeof getUrbanSignalsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await getUrbanSignals({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: getUrbanSignalsQueryKey(options)
});
