...
## Agent skills
- Issues/specs: `docs/agents/issue-tracker.md`
- Labels de triage: `docs/agents/triage-labels.md`
- Dominio single-context: `CONTEXT.md`, `docs/adr/`; ver `docs/agents/domain.md`
