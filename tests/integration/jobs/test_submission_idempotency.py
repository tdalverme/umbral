...
def test_ten_same_identity_submissions_return_one_execution() -> None:
...
def test_terminal_replay_publishes_nothing_and_new_key_reruns() -> None:
    queue = RecordingJobQueue()
    runtime = InMemoryJobRuntime(queue=queue)
...
def test_same_key_different_type_or_target_is_independent() -> None:
