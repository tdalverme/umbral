...
VOICE_EXAMPLES = ROOT / "contracts" / "agent" / "v5" / "voice-examples-v1.json"
...
REPLY_PROMPT = ROOT / "src" / "umbral" / "agent" / "prompts" / "reply-v5.md"
...
def test_voice_examples_text_fits_reply_schema() -> None:
    # Cada text debe ser valido como text de reply-schema-v5 (1..2000)
    for ex in _load_examples():
        payload = {
            "contract_version": "5",
            "text": ex["text"],
