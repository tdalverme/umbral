...
Uso:
    from umbral.application.conversation.v5.voice_check import lint_voice, score_rubric
...
def is_pass(text: str, *, has_proposal: bool = False) -> bool:
    ...
    en ReplyComposerV5 y en evals con outcomes.
    """
...
def check_grounded(text: str, outcomes: list[dict[str, object]]) -> list[str]:
    ...
    Para produccion, ReplyComposerV5 ya garantiza grounding via outcomes.
    """
