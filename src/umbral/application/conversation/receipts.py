...
from umbral.application.conversation.ports import EffectExecutorLike
...
class InMemoryCommandReceiptStore:
    ...
    def __init__(self) -> None:
        self._rows: dict[str, tuple[str, ExecutedAct | None, str | None]] = {}
...
def _effect_key_for(command: Command) -> str:
    from umbral.application.conversation.contracts import (
        ClearFilterCommand,
        CreateRadarCommand,
        RecordDesireCommand,
